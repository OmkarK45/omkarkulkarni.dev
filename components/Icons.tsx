...
export function VideoLibrary(props: SVGProps<SVGSVGElement>) {
  return (
...
export function Ecommerce(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
...
export function SocialMedia(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
